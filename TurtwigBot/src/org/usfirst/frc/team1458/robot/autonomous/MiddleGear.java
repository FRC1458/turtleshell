...
/**
 * This autonomous program will make the robot cross the baseline and place a gear in the middle peg.
 * The robot must start against the alliance station wall, facing the alliance station wall.
 *
 * @author asinghani
 */
public class MiddleGear extends SampleAutoMode {
	public MiddleGear(TankDrive chassis, Logger logger, TurtleNavX navX) {

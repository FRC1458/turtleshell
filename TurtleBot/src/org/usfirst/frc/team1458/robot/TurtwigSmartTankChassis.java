...
public class TurtwigSmartTankChassis implements TurtleSmartChassis {
	...
	this.driveMotors(pid.newValue(new double[] { lEncoder.getTicks(), rEncoder.getTicks(), lEncoder.getRate(), rEncoder.getRate(),
	...
	theta = maggie;
	theta.reset();
	pid = new TurtleTurnPID(TurtwigConstants.turnConstants, target, .45, 8, 26.5, TurtwigConstants.turnGyroConstants, 1.26,

...
\item Navigate to \path{~/wpilib/java/current/java/lib}. (\path{~} refers to the home directory, located at \path{/Users/username/} on Mac, \path{C:\Users\username} on Windows, and \path{/home/username} on UNIX.)
...
It contains several TurtleJoystickAxis, which can be retreived from it.
